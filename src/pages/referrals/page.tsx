      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
            ...
            <div className="text-3xl font-bold">{stats.pending.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
          </div>
          <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-5">
            <div className="text-sm text-gray-500">Pagado (USD)</div>
            <div className="text-3xl font-bold">{stats.paid.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</div>
          </div>
        </div>
                ...
                <tbody className="divide-y divide-gray-100">
                  {purchases.map((p) => (
                    <tr key={p.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-4 py-2 text-right">{`${p.currency} ${(Number(p.amount)||0).toLocaleString(undefined,{minimumFractionDigits:2})}`}</td>
